...
type ProduceRequest struct {
	...
	ProducerId     uint64                 `protobuf:"varint,5,opt,name=producer_id,json=producerId,proto3" json:"producer_id,omitempty"`
	SequenceNumber int64                  `protobuf:"varint,6,opt,name=sequence_number,json=sequenceNumber,proto3" json:"sequence_number,omitempty"` // A monotonically increasing number for each message from this producer.
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *ProduceRequest) GetProducerId() uint64 {
	if x != nil {
		return x.ProducerId
	}
	return 0
...
func (x *ProduceRequest) GetSequenceNumber() int64 {
	if x != nil {
...
type JoinGroupResponse struct {
	...
	// The following fields are ONLY sent to the group leader.
	// These are all the information consumer leader needs to create an assignment plan.
...
// Consumer leader sends this request to coordination after it figured out the partition assignment
...
type SyncGroupResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ErrorCode     ErrorCode              `protobuf:"varint,1,opt,name=error_code,json=errorCode,proto3,enum=api.ErrorCode" json:"error_code,omitempty"`
	Assignment    *PartitionAssignment   `protobuf:"bytes,2,opt,name=assignment,proto3" json:"assignment,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_api_kafka_proto_rawDesc = "" +
	...
	"\x06offset\x18\x02 \x01(\x03R\x06offset\"\xc5\x01\n" +
	...
	"\x03ack\x18\x04 \x01(\x0e2\r.api.AckLevelR\x03ack\x12\x1f\n" +
	"\vproducer_id\x18\x05 \x01(\x04R\n" +
	"producerId\x12'\n" +
	"\x0fsequence_number\x18\x06 \x01(\x03R\x0esequenceNumber\"y\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x12.api.TopicMetadataR\x05value:\x028\x01\"5\n" +
	...
	"\x03ALL\x10\x012\x9d\x04\n" +
	"\x05Kafka\x124\n" +
	"\aProduce\x12\x13.api.ProduceRequest\x1a\x14.api.ProduceResponse\x124\n" +
	"\aConsume\x12\x13.api.ConsumeRequest\x1a\x14.api.ConsumeResponse\x12C\n" +
	"\fCommitOffset\x12\x18.api.CommitOffsetRequest\x1a\x19.api.CommitOffsetResponse\x12@\n" +
	"\vFetchOffset\x12\x17.api.FetchOffsetRequest\x1a\x18.api.FetchOffsetResponse\x12+\n" +
	"\x04Join\x12\x10.api.JoinRequest\x1a\x11.api.JoinResponse\x12:\n" +
	...
	"\tHeartbeat\x12\x15.api.HeartbeatRequest\x1a\x16.api.HeartbeatResponse\x12@\n" +
	"\vCreateTopic\x12\x17.api.CreateTopicRequest\x1a\x18.api.CreateTopicResponseB\x0eZ\fkafka-go/apib\x06proto3"
...
var file_api_kafka_proto_goTypes = []any{
	...
	(*PartitionAssignment)(nil),  // 16: api.PartitionAssignment
	(*SyncGroupRequest)(nil),     // 17: api.SyncGroupRequest
	(*SyncGroupResponse)(nil),    // 18: api.SyncGroupResponse
...
var file_api_kafka_proto_depIdxs = []int32{
	...
	16, // 7: api.SyncGroupResponse.assignment:type_name -> api.PartitionAssignment
	...
	16, // 11: api.SyncGroupRequest.AssignmentsEntry.value:type_name -> api.PartitionAssignment
	...
	17, // 18: api.Kafka.SyncGroup:input_type -> api.SyncGroupRequest
	...
	18, // 27: api.Kafka.SyncGroup:output_type -> api.SyncGroupResponse
