...
const file_api_kafka_proto_rawDesc = "" +
	...
	"\tHeartbeat\x12\x15.api.HeartbeatRequest\x1a\x16.api.HeartbeatResponseB\x0eZ\fkafka-go/apib\x06proto3"
...
var file_api_kafka_proto_depIdxs = []int32{
	...
	16, // 10: api.SyncGroupRequest.AssignmentsEntry.value:type_name -> api.PartitionAssignment
	...
	17, // 17: api.Kafka.SyncGroup:input_type -> api.SyncGroupRequest
	...
	18, // 25: api.Kafka.SyncGroup:output_type -> api.SyncGroupResponse
